# Shawn Mendes — Music Guessing Game

A standalone version of the "tastedtracks"-style guessing game, scoped to
Shawn Mendes' discography. Plain Vite + React + TypeScript + Tailwind —
no Higgsfield dependency, so it deploys anywhere for free.

## What's included

- **81 tracks** across Shawn Mendes' catalog, each wired to a real short
